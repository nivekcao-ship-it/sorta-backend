 ...
 */
export declare class BedrockCwDashboard extends Construct {
    /**
    ...
    addModelMonitoring(modelName: string, modelId: string, props?: ModelMonitoringProps): void;
    addAllModelsMonitoring(props?: ModelMonitoringProps): void;
    /**
     * Add guardrail monitoring to the dashboard
     * @param {IGuardrail} guardrail - The guardrail to monitor
     */
    addGuardrailMonitoring(guardrail: IGuardrail): void;
    /**
     * Add guardrail monitoring to the dashboard
     */
