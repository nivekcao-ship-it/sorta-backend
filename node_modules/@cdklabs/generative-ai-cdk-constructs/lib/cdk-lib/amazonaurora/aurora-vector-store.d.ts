...
declare abstract class BaseAmazonAuroraVectorStore extends Construct {
    ...
    protected setupDatabaseClusterResources(vpc: ec2.IVpc, secret: secretsmanager.ISecret, clusterIdentifier: string, auroraSecurityGroup: ec2.ISecurityGroup): DatabaseClusterResources;
    protected createLambdaSecurityGroup(vpc: ec2.IVpc): ec2.SecurityGroup;
    protected addIngressRuleToAuroraSecurityGroup(lambdaSecurityGroup: ec2.ISecurityGroup, auroraSecurityGroup: ec2.ISecurityGroup): void;
